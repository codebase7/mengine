...
#else	/* COMMON_RENDER_SUBSYSTEM_H */
...
/* Define C functions. */
/*!
 *	int Common_Renderer_Get_Rendering_Subsystem_API_Major_Version_Number()
 *
 *	Returns the major version number of the Rendering Subsystem.
 */
MSYS_DLL_EXPORT int Common_Renderer_Get_Rendering_Subsystem_API_Major_Version_Number();

/*!
 *	int Common_Renderer_Get_Rendering_Subsystem_API_Minor_Version_Number()
 *
 *	Returns the minor version number of the Rendering Subsystem.
 */
MSYS_DLL_EXPORT int Common_Renderer_Get_Rendering_Subsystem_API_Minor_Version_Number();

/*!
 *	int Common_Renderer_Get_Rendering_Subsystem_API_Revision_Version_Number()
 *
 *	Returns the revision version number of the Rendering Subsystem.
 */
MSYS_DLL_EXPORT int Common_Renderer_Get_Rendering_Subsystem_API_Revision_Version_Number();

/*!
 * 	bool Common_Renderer_Calculate_Offsets_From_Coordnates(const long destXCoordOffset, const long destYCoordOffset, const size_t destXAxisResolution, const size_t destYAxisResolution,
 ...
 */
MSYS_DLL_EXPORT bool Common_Renderer_Calculate_Offsets_From_Coordnates(const long destXCoordOffset, const long destYCoordOffset, const size_t destXAxisResolution, const size_t destYAxisResolution,
																		const size_t sourceXAxisResolution, const size_t sourceYAxisResolution, size_t * currentSourceXCoordOffset, size_t * currentDestXCoordOffset, size_t * currentDestOffset,
																		size_t * currentSourceOffset, size_t * nextDestEndOfLineOffset, size_t * nextSourceEndOfLineOffset);
...
namespace Common
{
	namespace Renderer
	{
		 ...
		 *	Returns the major version number of the Rendering Subsystem.
		 *
		 *	(Wrapper to Common_Renderer_Get_Rendering_Subsystem_API_Major_Version_Number().)
		 */
		 ...
		 *	Returns the minor version number of the Rendering Subsystem.
		 *
		 *	(Wrapper to Common_Renderer_Get_Rendering_Subsystem_API_Minor_Version_Number().)
		 */
		 ...
		 *	Returns the revision version number of the Rendering Subsystem.
		 *
		 *	(Wrapper to Common_Renderer_Get_Rendering_Subsystem_API_Revision_Version_Number().)
		 */
		 ...
		 * 								 size_t & currentSourceOffset, size_t & nextDestEndOfLineOffset, size_t & nextSourceEndOfLineOffset)
		 *
		 * 	(Wrapper to Common_Renderer_Calculate_Offsets_From_Coordnates().)
		 */
...
#endif	/* COMMON_RENDER_BASIC_FUNCTIONS_H */
