...
/* Common namespace error code definitions. (Human-readable error message translation table is located in Common_Error_Handler_Structures.c) */
	enum {
		...
		RENDERER_ERROR_UNABLE_TO_ALLOC_OI_BUF = -22,	/* Overlay image buffer. */
		RENDERER_ERROR_UNABLE_TO_ALLOC_TD_BUF = -23,	/* Transparency data buffer. */
		RENDERER_ERROR_MEM_BUF_ALLOC_EXCEPTION = -24,
		RENDERER_ERROR_DUPE_OVERLAY_EXCEPTION = -25,
		RENDERER_ERROR_INVAL_OVERLAY_SELF_OVERWRITE = -26,
		RENDERER_ERROR_TRANSPARENCY_DISABLED = -27,
