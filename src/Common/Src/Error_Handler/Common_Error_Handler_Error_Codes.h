...
/* Common namespace error code definitions. (Human-readable error message translation table is located in Common_Error_Handler_Structures.c) */
	enum {
		...
		COMMON_ERROR_FALSE_SUCCESS = -23,
		COMMON_ERROR_PEBKAC_OPERATION_ALREADY_COMPLETED = -24,
		COMMON_ERROR_NO_DATA = -25,
		COMMON_ERROR_DATA_CORRUPTION = -26,
		COMMON_ERROR_SYSTEM_LIMIT_EXCEEDED = -27,
		COMMON_ERROR_MEMORY_BUFFER_TOO_SMALL = -28,
		...
		RENDERER_ERROR_UNABLE_TO_ALLOC_OI_BUF = -175,	/* Overlay image buffer. */
		RENDERER_ERROR_UNABLE_TO_ALLOC_TD_BUF = -176,	/* Transparency data buffer. */
		RENDERER_ERROR_MEM_BUF_ALLOC_EXCEPTION = -177,
		RENDERER_ERROR_DUPE_OVERLAY_EXCEPTION = -178,
		RENDERER_ERROR_INVAL_OVERLAY_SELF_OVERWRITE = -179,
		RENDERER_ERROR_TRANSPARENCY_DISABLED = -180,
	};
