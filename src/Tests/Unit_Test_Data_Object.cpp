...
int Unit_Test_Data_Object()
{
        /*!
                ...
                Void Error Codes:
                    ...
                    -1016   DataProcess::Data_Object::Compare() Comparasion failed should have passed.
                    -1017   DataProcess::Data_Object::NCompare() Comparasion passed should have failed.
                    -1018   DataProcess::Data_Object::Compare() Comparasion passed should have failed.
                    -1019   DataProcess::Data_Object::NCompare() Comparasion failed should have passed.
                    -1020   DataProcess::Data_Object::insert() Could not insert data (returned 0).
        ...
        */
        ...
        if (test_object_1.Compare(test_object_2))
        {
                // DataProcess::Data_Object::Compare() Comparasion passed should have failed.
                return -1018;
        }
        ...
        if (!(test_object_1.NCompare(test_object_2)))
        {
                // DataProcess::Data_Object::NCompare() Comparasion failed should have passed.
                return -1019;
        }
