...
class ERROR {
  ...
  public:
        ...
        */
        MSYS_DLL_EXPORT std::string ReturnLastError() const;
        ...
        */
        MSYS_DLL_EXPORT std::string PanicHandler(const std::string & message, const int & moduleID = 0, const unsigned int & log_level = ERROR_CRITICAL, const bool & killengine = false);
        ...
        */
        MSYS_DLL_EXPORT short enable_logging(const std::string & path_to_logfile, const unsigned int & log_level, const unsigned int & max_lines);
        ...
        */
        MSYS_DLL_EXPORT void disable_logging();
        ...
        */
        MSYS_DLL_EXPORT void change_log_level(const unsigned int & log_level)
        {
        ...
        */
        MSYS_DLL_EXPORT unsigned int get_log_level() const;
        ...
        */
        MSYS_DLL_EXPORT bool is_logging_enabled() const;
        ...
        */
        MSYS_DLL_EXPORT std::string get_log_file_path() const;
        ...
        */
        MSYS_DLL_EXPORT unsigned int get_max_log_lines() const;
    ...
    */
    MSYS_DLL_EXPORT const char * Get_Library_Version();
    ...
    */
    MSYS_DLL_EXPORT const char * Get_Library_Compile_Date();
